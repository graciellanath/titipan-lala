...
export default () => {
  return (
    ...
    >
      <SwiperSlide>
        {/* Card 1 */}
        <div className="destination-card relative overflow-hidden hover:cursor-pointer md:w-[400px] w-full mb-8">
          <img
            src={banggai}
            alt="Destination 1"
            className="destination-image"
          />
          <div className="destination-info absolute top-0 w-full h-full bg-black bg-opacity-60 text-white opacity-0 hover:opacity-100 transition-opacity duration-300 ease-in-out p-4">
            <h2 className="md:text-xl text-md px-4 font-bold">
              Lake Paisu Pok Luk Panenteng
            </h2>
      ...
      <SwiperSlide>
        {/* Card 2 */}
        <div className="destination-card relative hover:cursor-pointer md:w-[400px] w-full mb-8">
